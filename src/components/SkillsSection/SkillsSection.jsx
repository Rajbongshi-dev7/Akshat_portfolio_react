...
const SKILLS = [
  ...
  },
  {
    ...
    icon: "🎨",
    color: "#a78bfa",
    desc: "Flexbox, Grid, and responsive mastery.",
    wide: false,
  },
  {
    name: "Tailwind",
    ...
    icon: "💨",
    color: "#38bdf8",
    desc: "Utility-first rapid development systems.",
    wide: false,
  },
  {
    name: "JavaScript",
    ...
    icon: "⚡",
    color: "#fbbf24",
    desc: "ES6+, DOM mastery, and async patterns.",
    wide: false,
  },
  {
    name: "React.js",
...
const SkillSection = () => {
  ...
  return (
    <section className="py-24 px-[5vw] bg-[#060810]" id="skills">
      {/* SECTION LABEL */}
      <motion.div
        initial="hidden"
        whileInView="show"
            ...
            >
              ...
              <div className="relative shrink-0">
                <svg className="w-20 h-20 md:w-24 md:h-24 -rotate-90 overflow-visible">
                  ...
                  {/* 2. THE NEON OUTER GLOW (The "Bleed" effect) */}
                  <motion.circle
                    cx="50%"
                    cy="50%"
                    r="38"
                    fill="none"
                    stroke={skill.color}
                    strokeWidth="2" // Wider for more surface area
                    strokeLinecap="round"
                    ...
                    style={{
                      filter: "blur(3px)", // Increased blur for atmospheric glow
                      opacity: 0.5,
                    }}
                  />

                  {/* 3. THE NEON CORE (The "Light Source") */}
                  <motion.circle
                    cx="50%"
                    cy="50%"
                    r="38"
                    ...
                    style={{
                      filter: `drop-shadow(0 0 5px ${skill.color})  drop-shadow(0 0 10px ${skill.color})`, // Stacked shadows for intensity
                    }}
                  />
                </svg>
              ...
              <div className="flex-1 min-w-0">
                ...
                <p
                  className={`text-sm text-gray-400 font-light leading-relaxed ${!skill.wide && "hidden group-hover:block"}`}
                >
                  {skill.desc}
                </p>
              </div>
