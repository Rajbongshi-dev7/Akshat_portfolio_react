        ...
        <div className="grid grid-cols-1 gap-4">
          ...
          <div className=" bg-[#1c1c1e]/50 border border-white/5 rounded-t-xl pt-20 pb-28 px-16  flex flex-col justify-center relative overflow-hidden group">
            ...
            <div className="flex items-center gap-3 mb-8">
              ...
              <span className="font-tech text-blue-400 text-xs uppercase tracking-[0.3em]">
                Status: Ready for Production
              </span>
            </div>

            {/* The "Indestructible" Bold Heading */}
            <h1 className="font-brand font-extrabold text-5xl md:text-8xl text-gray-200 leading-[0.9] tracking-tighter uppercase mb-10">
              Building <br />
            ...
            <button className="px-10 py-4 w-fit bg-white text-black font-black font-brand cursor-pointer rounded-full hover:bg-blue-400 transition-all uppercase text-xs tracking-widest shadow-lg  shadow-cyan-500  hover:shadow-gray-300">
              Explore Builds
            </button>
